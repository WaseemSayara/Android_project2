...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    String SQL_CREATE_TABLE_HOUSES = "CREATE TABLE " + TABLE_HOUSES + "(" + ID_COL + " INTEGER PRIMARY KEY AUTOINCREMENT," + AGENCY_NAME_COL + " TEXT,"+ AGENCY_USER_ID_COL + " INTEGAR NOT NULL,"
            ...
            " TEXT,"+ AVAILABILITY_DATE_COL + " TEXT NOT NULL,"+ DESCRIPTION_COL + " TEXT NOT NULL)";
